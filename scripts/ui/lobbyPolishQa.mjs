...
if (MODE === "contracts") {
  ...
  ok("the header renders one image — the manifested Mk1 mark — and no league mark", (header.match(/<img\b/g) || []).length === (header.match(/data-brand-mark="eraclash-logo-mk1"/g) || []).length && /* the desktop header and the compact phone header each render the same mark */ /data-brand-mark="eraclash-logo-mk1"/.test(header) && !/\bnba\b/i.test(header) && json("data/validation/9a2/logo-mk1-manifest.json").product.path === "public/brand/eraclash-logo-mk1.png");
