...
if (MODE === "semantic") {
  ...
  // Unified Light UI release: the arena's neutral structure is Warm Court Ivory + Editorial Ink (shared tokens); the header stays obsidian and the portrait well stays dark.
  ok("ivory/ink is the neutral structure (arena text is Editorial Ink on Warm Court Ivory; header obsidian; portrait well dark)", t.arena.text === NIGHT_COURT_V1.layer2.editorialInk && t.arena.bg === NIGHT_COURT_V1.layer2.warmCourtIvory && t.arena.header.startsWith("rgba(3, 6, 11") && t.arena["portrait-well-lo"] === "#0B1220");
