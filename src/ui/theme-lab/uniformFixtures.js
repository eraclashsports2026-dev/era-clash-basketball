...
// in the uniform colours the product must survive — plus the two fallback tiers
// (the generated archetype placeholder, and the masked silhouette beneath it). They are NOT likenesses and
...
/** id · label · team side · the jersey swatch · whether the image is grayscale (history) · testArt (a synthetic figure, or a pinned fallback tier) · slot: which frozen roster card carries it */
export const UNIFORM_TESTS = Object.freeze([
  ...
  { id: "silhouette-gold", label: "Silhouette fallback (Gold)", team: "gold", jersey: null, art: { tier: "silhouette" } },
  { id: "placeholder-gold", label: "Archetype placeholder (Gold)", team: "gold", jersey: null, slot: 4, art: { tier: "placeholder" } },
  ...
  { id: "silhouette-blue", label: "Silhouette fallback (Blue)", team: "blue", jersey: null, art: { tier: "silhouette" } },
  { id: "placeholder-blue", label: "Archetype placeholder (Blue)", team: "blue", jersey: null, slot: 1, art: { tier: "placeholder" } },
