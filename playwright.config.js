...
export default defineConfig({
  ...
  projects: [
    {
      ...
      testIgnore: /(daily-coach-era|phase7b-preview|phase8a-chaos|phase8c-time-arena|phase9a-play-lobby|phase9a3p-lobby-polish|phase9c-challenges|phase9d-progression)\.spec\.js/,
    },
    {
    ...
    },
    {
      ...
      testMatch: /(phase9c-challenges|phase9d-progression)\.spec\.js/,
  ...
  webServer: [
    ...
    },
    {
      ...
      reuseExistingServer: true,
      timeout: 30_000,
      env: { PREVIEW_SIM_ENGINE_ENABLED: "true", VERCEL_ENV: "preview", ECLASH_FAKE_CLOUD: "1", RL_PROFILE_PER_MIN_IP: "500", RL_CHALLENGE_ACTIONS_PER_MIN_IP: "500", RL_CHALLENGE_VIEW_PER_MIN_IP: "500", RL_PROGRESSION_PER_MIN_IP: "500" },
    },
  ],
});
